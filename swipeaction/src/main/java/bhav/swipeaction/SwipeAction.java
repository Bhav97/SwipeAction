...
//        if (size != MaterialSearchDrawable.LARGE && size != MaterialSearchDrawable.DEFAULT) {
//            return;
//        }
//        final DisplayMetrics metrics = getResources().getDisplayMetrics();
//        if (size == MaterialSearchDrawable.LARGE) {
...
//    }
     ...
     *
     * @param show Whether or not the view should show refresh progress.
     */
    public void setWorking(boolean show) {
        if (show && mRefreshing != show) {
            // scale and show
            mRefreshing = show;
            int endTarget;
            if (!mUsingCustomStart) {
...
//            icon.setAlpha(MAX_ALPHA);
    ...
    private void setWorking(boolean refreshing, final boolean notify) {
...
//                                * interpolatedTime)));
     ...
     */
    @ColorInt
    public void setColors(int iconColor, int backgroundColor) {
        ensureTarget();
        //todo : set color of icon and background
